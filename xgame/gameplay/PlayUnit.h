...
#include "xgame/player/GamePlayerCollection.h"
...
public:
	...
	// 是不是有这个玩家
	//------------------------------------------------------------------------
	virtual bool IsExistPlayer(int64_t nPlayerGUID);
	...
	// 获得所有战斗者
	//------------------------------------------------------------------------
	virtual const std::vector<GamePlayerPtr>& GetAllFighter();

	//------------------------------------------------------------------------
	// 获得所有观战者
	//------------------------------------------------------------------------
	virtual const std::vector<GamePlayerPtr>& GetAllObserver();
...
public:
	...
	// 能不能关闭
	//------------------------------------------------------------------------
	virtual bool IsCanClose(int64_t nPlayerGUID);
